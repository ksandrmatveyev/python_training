...
def get_args():
    ...
    parser = argparse.ArgumentParser(description='AWS stack wrapper', add_help=False)
    parser.add_argument('stack_name', help='set stack name')
    ...
    # Create stack parser
    parser_create = subparsers.add_parser('create-stack', parents=[parser], help='create new stack from file')
    parser_create.add_argument('file', help='set file path')

    parser_create.set_defaults(func=create_stack)

    # Update stack parser
    parser_update = subparsers.add_parser('update-stack', parents=[parser], help='update existing stack from file')
    parser_update.add_argument('file', help='set file path')
    parser_update.set_defaults(func=update_stack)

    # Delete stack parser
    parser_delete = subparsers.add_parser('delete-stack', parents=[parser], help='delete existing stack')
